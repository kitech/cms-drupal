...
// Layout Settings
  ...
  $form['tnt_container']['layout_settings']['searchimg'] = array(
    '#type' => 'checkbox',
    '#title' => t('Icon in search block'),
    '#description' => t('Change the standard button with a lens icon.'),
