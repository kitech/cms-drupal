...
<?php if (theme_get_setting('searchimg')): ?>
  ...
  <?php endif; ?>
	...
	<label class="element-invisible" id="edit-search-block-form-img">Search</label>
		<input type="text" maxlength="128" name="search_block_form" id="edit-search-theme-form-img" size="15" value="" placeholder="<?php print t('Search') ?>" title="Enter the terms you wish to search for." class="form-text" />
