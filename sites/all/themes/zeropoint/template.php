...
// Set grids responsive stylesheets
  drupal_add_css(drupal_get_path('theme','zeropoint').'/css/drupal/drupal-system-min.css', array('group' => CSS_SYSTEM, 'every_page' => TRUE, 'weight' => -5));
  drupal_add_css(drupal_get_path('theme','zeropoint').'/css/drupal/drupal-default-min.css', array('group' => CSS_DEFAULT, 'every_page' => TRUE, 'weight' => -5));

  if(theme_get_setting('css_zone')) {
    drupal_add_css('https://unpkg.com/purecss@'.get_css_version().'/build/pure-min.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => -5, 'preprocess' => FALSE));
  } else {
    drupal_add_css(drupal_get_path('theme','zeropoint').'/css/yui/'.get_css_version().'/pure-min.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => -5, 'preprocess' => TRUE));
  }
  if(theme_get_setting('grid_responsive') == '1') {
    if(theme_get_setting('css_zone')) {
      drupal_add_css('https://unpkg.com/purecss@'.get_css_version().'/build/grids-responsive-old-ie-min.css', array('group' => CSS_THEME, 'browsers' => array('IE' => 'IE 8', '!IE' => FALSE), 'every_page' => TRUE, 'weight' => -4, 'preprocess' => FALSE));
      drupal_add_css('https://unpkg.com/purecss@'.get_css_version().'/build/grids-responsive-min.css', array('group' => CSS_THEME, 'browsers' => array('IE' => 'gt IE 8'), 'every_page' => TRUE, 'weight' => -4, 'preprocess' => FALSE));
    } else {
      drupal_add_css(drupal_get_path('theme','zeropoint').'/css/yui/'.get_css_version().'/grids-responsive-old-ie-min.css', array('group' => CSS_THEME, 'browsers' => array('IE' => 'IE 8', '!IE' => FALSE), 'every_page' => TRUE, 'weight' => -4, 'preprocess' => TRUE));
      drupal_add_css(drupal_get_path('theme','zeropoint').'/css/yui/'.get_css_version().'/grids-responsive-min.css', array('group' => CSS_THEME, 'browsers' => array('IE' => 'gt IE 8'), 'every_page' => TRUE, 'weight' => -4, 'preprocess' => TRUE));
    }
  }

  drupal_add_css(drupal_get_path('theme','zeropoint').'/css/style-zero.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => 3, 'preprocess' => TRUE));
  drupal_add_css(drupal_get_path('theme','zeropoint').'/css/'.get_zeropoint_style().'.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => 4, 'preprocess' => TRUE));
  drupal_add_css(drupal_get_path('theme','zeropoint').'/_custom/custom-style.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => 6, 'preprocess' => TRUE));
  drupal_add_css(drupal_get_path('theme','zeropoint').'/css/print.css', array('group' => CSS_THEME, 'media' => 'print', 'every_page' => TRUE, 'weight' => 7, 'preprocess' => TRUE));
...
// Add javascript and CSS files for jquery slideshow.
  if (theme_get_setting('slideshow_display')) {
    if (drupal_is_front_page() || theme_get_setting('slideshow_all')) {
      drupal_add_css(drupal_get_path('theme','zeropoint').'/css/slider.css', array('group' => CSS_THEME, 'media' => 'screen', 'every_page' => TRUE, 'weight' => 2, 'preprocess' => TRUE));
      drupal_add_js(drupal_get_path('theme', 'zeropoint').'/js/jquery.flexslider-min.js', array('group' => JS_THEME, 'media' => 'screen', 'every_page' => TRUE, 'weight' => 2, 'preprocess' => TRUE, 'scope' => 'footer', 'defer' => TRUE));
      drupal_add_js(drupal_get_path('theme', 'zeropoint').'/js/slide.js', array('group' => JS_THEME, 'media' => 'screen', 'every_page' => TRUE, 'weight' => 2, 'preprocess' => TRUE, 'scope' => 'footer', 'defer' => TRUE));
    }
  }
}
